 ...
 */
function findKingSquare(board: ReturnType<Chess['board']>, kingColor: 'w' | 'b'): string | null {
...
describe('Check and Checkmate Detection', () => {
  it('should detect king in check position', () => {
    ...
    const chess = new Chess('rnbqkbnr/pppp1ppp/8/4p3/6PP/5P2/PPPPP2P/RNBQKBNR w KQkq - 0 1');
