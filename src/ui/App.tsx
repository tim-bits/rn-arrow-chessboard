...
const didRunRef = useRef(false);
  ...
  React.useEffect(() => {
    ...
    if (didRunRef.current) {
      ...
      await arrows([['e2', 'e4'], ['d2', 'd4']]); // e4 is best (thicker)
      ...
      await arrows([['e7', 'e5'], ['c7', 'c6'], ['g8', 'f6']]); // e5 is best
      ...
      await arrows([['f1', 'c4'], ['b1', 'c3'], ['c1', 'f4']]);
      ...
      <ScrollView style={styles.scrollContainer} contentContainerStyle={styles.contentContainer}>
        <View style={styles.container}>
          <Text style={styles.title}>
            Interactive Chessboard ------------------------------------------ Auto-Play Demo!!!
          </Text>
          <Chessboard
          moveAnimationDuration={MOVE_ANIMATION_DURATION}
            key={demoKey}
            position={initialFen}
            boardSize={Dimensions.get('window').width > Dimensions.get('window').height ? 
              Dimensions.get('window').width * 0.5 : Dimensions.get('window').height * 0.5}
